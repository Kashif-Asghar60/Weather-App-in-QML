...
Window {
    ...
    property var weatherData: [
        ...
        function startWeatherCycle() {
            ...
            sun.state = "toMoon";
            startAnimation.running = true; // Ensure the animation starts
        ...
        function updateWeather() {
            if (isWeatherCycling) {
                ...
                sun.state = weatherState === 0 ? "default" : (weatherState === 1 ? "toMoon" : "toFrostySun");
    ...
    SequentialAnimation {
        ...
        PauseAnimation { duration: 1000 } // Pause to see repeater
